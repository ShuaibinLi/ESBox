import unittest
import numpy as np
from esbox.problems.functions import Rastrigin
...
class RastriginFuncTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_x = [-0.68]
        self.test_y = {1: 14.72019291565072, 2: 29.44038583130144, 10: 147.20192915650722, 100: 1472.019291565072}
        self.low_y = {1: 28.924713725785896, 2: 57.84942745157179, 10: 289.247137257859, 100: 2892.4713725785896}
    ...
    def test_diff_dims(self):
        for dim in self.test_dims[1:]:
            self.dim = dim
            self.problem = Rastrigin(dim=self.dim)
